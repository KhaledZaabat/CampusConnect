...
<?php include 'headerAdmin.php' ?>
    <div class="container2">
        ...
        <form action="#" method="post" class="student-form , admin-form" id="admin" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn_submit" id="admin">Add User</button>
        </form>
    </div>
        ...
        <table>
            ...
            <tbody id="admin-table-body">
                ...
                <tr>
                    ...
                    <td><input type="text" class="tableinput name" value="mohamed elhadi" disabled></td>
                    <td><input type="text" class="tableinput name Lname" value="taieb ezraimmi" disabled></td>
